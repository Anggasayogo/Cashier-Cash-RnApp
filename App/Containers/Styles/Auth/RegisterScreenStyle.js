...
export default connect({
  ...
  icons: "w-24 h-24",
  register: "font-medium text-14",
  title: "text-24 font-medium",
  childTitle: "text-14 font-regular my-2",
  loginWithUs: "flex text-center font-bold text-14",
  btnSosmed: "border-1 border-gray-default rounded-7 py-3 row px-4 items-center my-1",
  haveAccount: "text-center my-4 font-regular text-14",
  menyetujui: "mx-4 font-regular text-center mt-7",
})
